...
"\055e regex -e ^print s21_grep.c VAR -f test_ptrn_grep.txt"
"\055e while -e void s21_grep.c Makefile VAR -f test_ptrn_grep.txt"
"VAR no_file.txt"
)
...
"\055e = -e out test_5_grep.txt"
"\055e ing -e as -e the -e not -e is test_6_grep.txt"
